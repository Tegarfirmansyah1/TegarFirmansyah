...
export default function Contact() {
    return (
        <section id="contact" className="bg-retro-bg py-20 scroll-mt-[88px]">
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 font-retro">Get In Touch</h2>
                <div className="max-w-xl mx-auto bg-white rounded-xl shadow-lg p-6 md:p-8 border-4 border-retro-text">
                    <form id="contactForm" action="https://formspree.io/f/xeoekrde" method="POST" className="space-y-4">
                        <div>
                            <input 
                                type="text" name="name" placeholder="Name" required
                                className="w-full px-4 py-3 bg-retro-bg border-2 border-retro-text rounded-lg focus:outline-none focus:ring-2 focus:ring-retro-blue font-retro text-lg transition duration-300"
                            />
                        </div>
                        <div>
                            <input 
