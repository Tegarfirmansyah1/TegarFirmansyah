    ...
    return (
        <section id="home" className="min-h-screen bg-primary flex items-center justify-center scroll-mt-[88px]">
            <div className="max-w-4xl mx-auto px-4 py-20 items-center justify-center text-center text-white">
                ...
                <a href="#projects">
                    <button className="bg-secondary text-white px-6 py-2 rounded-lg hover:bg-opacity-90 transition duration-300 font-retro border-2 border-text shadow-[5px_5px_0px_theme(colors.text)] hover:shadow-none hover:translate-x-1 hover:translate-y-1">
                        View My Work
                    </button>
                </a>
            </div>
